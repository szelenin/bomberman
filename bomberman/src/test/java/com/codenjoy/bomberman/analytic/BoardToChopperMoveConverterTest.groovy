...
class BoardToChopperMoveConverterTest extends Specification {
    ...
    def "convert board states"(def boardStrings, def expectedLines) {
        ...
        //dead chopper appears on new place
        ['&'(3, 2)._(BOMB_TIMER_1, 4, 2),
         'x'(2, 2)._(BOOM, 3, 2),
         '&'(7, 4)] | ['L,0,BOOM,0,0,DEATH']

        ['&'(2, 2)._(BOMB_TIMER_1, 3, 2),
         'x'(3, 2)._(BOOM, 4, 2),
         '&'(4, 4),'&'(3,4),'&'(2,4)] | ['R,0,BOOM,0,0,DEATH', 'L,0,0,0,0,L']
        ['&'(2, 2)._(BOMB_TIMER_1, 3, 2),
         'x'(3, 2)._(BOOM, 4, 2),
         '&'(5, 4)] | ['R,0,BOOM,0,0,DEATH']
    }
